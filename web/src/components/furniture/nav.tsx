    ...
    <>
      ...
      <div class="navbar bg-base-100">
        ...
        <div class="flex-none hidden md:flex">
          ...
          <div class="tooltip tooltip-bottom" data-tip={t('nav.theme')}>
          ...
          <li class="list-none px-2">
            <p
              ...
              class="cursor-pointer tooltip flex tooltip-bottom" data-tip={t('nav.settings')}>
        ...
        <div class="modal-box">
          ...
          <div class="modal-action justify-start w-full flex flex-col gap-4">
              <div class="flex items-between w-full justify-between">
                <label for="theme" class="label">{t('nav.theme')}</label>
                <select 
                  id="theme" 
                  class="select select-bordered w-full max-w-xs"
                  onChange$={(event) => setTheme((event.target as HTMLSelectElement).value) }
                  >
                  <option disabled selected>{t('nav.theme')}</option>
              ...
              <div class="flex items-between w-full justify-between">
                <label class="label">{t('nav.data')}</label>
                <button class="btn btn-primary" onClick$={deleteAllData}>{t('nav.deleteAll')}</button>
              </div>
              <button
